				 	...
				 	<div class="col-lg-9 column">
				 		<div class="bloglist-sec">
				 			<div class="blogpost style2">
				 				<div class="blog-posthumb"> <a href="#" title=""><img src="<?php echo get_template_directory_uri(); ?>/images/resource/bl1.jpg" alt="" /></a> </div>
				 			...
				 			<div class="blogpost style2">
				 				<div class="blog-posthumb"> <a href="#" title=""><img src="<?php echo get_template_directory_uri(); ?>/images/resource/bl2.jpg" alt="" /></a> </div>
				 				<div class="blog-postdetail">
				 					<ul class="post-metas"><li><a href="#" title=""><i class="la la-calendar-o"></i>November 23, 2017</a></li><li><a class="metascomment" href="#" title=""><i class="la la-comments"></i>4 comments</a></li></ul>
				 			...
				 			<div class="blogpost style2">
				 				<div class="blog-posthumb"> <a href="#" title=""><img src="<?php echo get_template_directory_uri(); ?>/images/resource/bl3.jpg" alt="" /></a> </div>
				 				<div class="blog-postdetail">
				 					<ul class="post-metas"><li><a href="#" title=""><i class="la la-calendar-o"></i>November 23, 2017</a></li><li><a class="metascomment" href="#" title=""><i class="la la-comments"></i>4 comments</a></li></ul>
						...
						<div class="widget">
				 		...
				 		<div class="widget">
				 			...
				 			<div class="post_widget">
				 				<div class="mini-blog">
				 					<span><a href="#" title=""><img src="<?php echo get_template_directory_uri(); ?>/images/resource/mb1.jpg" alt="" /></a></span>
				 					<div class="mb-info">
				 				...
				 				<div class="mini-blog">
				 					<span><a href="#" title=""><img src="<?php echo get_template_directory_uri(); ?>/images/resource/mb2.jpg" alt="" /></a></span>
				 					<div class="mb-info">
				 				...
				 				<div class="mini-blog">
				 					<span><a href="#" title=""><img src="<?php echo get_template_directory_uri(); ?>/images/resource/mb3.jpg" alt="" /></a></span>
				 					<div class="mb-info">
